...
function App() {
  ...
  return ( // 리턴에 걸려있는 내용을 화면에 그리고 있는 것

  <Fragment>
    <ul>
      <li> 1. 주석 alt + shift + a {/* 주석 */}</li>
      <li> 2. return구문은 반드시 1개여야 합니다. 반드시 하나의 태그를 리턴해야 합니다.</li>
      ...
      <li> 8. DOM에 직접 스타일을 하고싶은 경우는 객체로 묶고 속성은 카멜표기법을 반드시 사용합니다 (단위생략시 px)</li>
      <li> 9. class 속성 대신에 className 태그를 사용합니다</li>
      <li> 10. 홀로 사용하는 태그는 반드시 닫는 태그를 작성합니다 예시: <input></input>, <br /> 등</li>
    </ul>

    <div className="App" style={{color: 'red', backgroundColor: 'yellow', fontSize: 15}}>
    {/* <div style={myStyle}> */}
